...
async function getResources(page) {
  ...
  console.log("")
  console.log("no. of files to be downloaded" + 1)
  var downloads = 0
  for (let index = 0; index < array.length; index++) {
    ...
    try {
      ...
      await streamPipeline(response.body, fs.createWriteStream('./[B]' + name))
...
function getUserInput() {
  ...
  prompt.get(properties, function (err, result) {
    ...
    COURSENAME = "E20 - Algorithms and Data Structures [520191U004]"
